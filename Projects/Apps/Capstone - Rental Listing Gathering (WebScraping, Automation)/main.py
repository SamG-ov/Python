...
# get the website (instead of Zillow.com)
...
for n in range(len(all_links)):
    driver.get("https://docs.google.com/forms/d/e/1FAIpQLSfW_V0zb9_aKiY3CudtW2kSRcTHwt_zempf69kLUWyILrosWg/viewform?usp=sharing&ouid=117602278348562902381")
    time.sleep(2)
